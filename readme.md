...
| ---------------- | ------------------- | -------------------------- | ------------------------------------------------ |
| Block data       | `/blocks`           | General                    | [Sample JSON](explorer/mocks/blocks.json)        |
| Transaction data | `/blocks/:height`   | Transaction data per block | [Sample JSON](explorer/mocks/blocks.height.json) |
| Address data     | `/address/:address` | Address history            | [Sample JSON](explorer/mocks/addres.json)        |
